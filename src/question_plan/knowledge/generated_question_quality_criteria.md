...
- Nếu solution chỉ nêu đáp án cuối, giá trị cuối hoặc nhãn phương án như
  "Đáp án C", "Kết quả là 2", "Chọn B" mà không có bất kỳ lý do,
  bước suy luận hoặc giải thích nào, tạo issue `solution_quality`.
- Không kiểm tra đáp án đó đúng hay sai; chỉ đánh giá việc solution thiếu
  nội dung giải thích.
- Dùng severity `warning` và repair_intent `needs_manual_review`, vì không
  được tự tạo lời giải mới từ instruction/stem.
- Không báo lỗi nếu solution ngắn nhưng vẫn có một lý do trực tiếp và đủ
  hiểu, ví dụ: "Theo định nghĩa thể tích lăng trụ, V = Sh nên chọn D."
